<template>
  <header
    class="p-6 flex flex-col xl:min-w-[260px] xl:max-w-[260px] w-full bg-black bg-gradient-to-b from-green-900/30 to-green-900/80 xl:min-h-screen duration-300 transition-all fixed top-0 left-0 z-50 xl:relative xl:pt-0"
  >
    <div class="xl:sticky top-5 left-0 right-0 custom-height-calc">
