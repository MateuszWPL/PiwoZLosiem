  ...
  <div class="flex h-screen w-full bg-gradient-to-b from-primaryGreen/0 to-primaryGreen/50 xl:flex-row overflow-hidden">
    ...
    <div class="flex-1 xl:hidden flex flex-col min-h-0 min-w-0 overflow-hidden">
      <div class="pt-20 px-4 pb-2 flex-shrink-0">
        ...
        <div class="flex items-center gap-3 pt-4 min-w-0">
          <div class="relative flex-1 min-w-0">
            <svg 
              class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 pointer-events-none text-secondaryGold"
            ...
            <input
              ...
              type="text"
              placeholder="Szukaj..."
              class="pl-10 pr-4 py-2 w-full min-w-0 border-2 border-secondaryGreen bg-tertiaryGreen text-secondaryGold placeholder-secondaryGold font-semibold rounded-2xl focus:outline-none focus:ring-1 focus:ring-secondaryGold"
            />
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-1 min-h-0 min-w-0 overflow-hidden">
        ...
        <div class="flex-1 min-w-0 overflow-hidden">
          <ChatRoomComp
            ...
            @back="handleBack"
          />
          <div v-else class="flex items-center justify-center h-full text-secondaryGold min-w-0">
            Wybierz czat
          </div>
        </div>
      </div>
