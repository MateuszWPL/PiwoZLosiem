      ...
      <div class="max-w-screen-xl mx-auto h-full">
        <div class="">
          <div class="flex items-center justify-between items-center">
            ...
            <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
              <div
                ...
                <button class="absolute top-2 right-2 text-gray-400 hover:text-white" @click="showModal = false"
                  aria-label="Zamknij">
                ...
                <form @submit.prevent="addBeer">
                  <div class="mb-3">
                    ...
                    <input id="beerAmount" v-model="beerAmount" type="number" min="1"
                  ...
                  <div class="mb-3">
                    ...
                    <input id="beerType" v-model="beerType" type="text"
                      class="w-full rounded px-3 py-2 bg-neutral-800 text-white border border-neutral-700 focus:outline-none focus:border-primaryOrange"
                      required />
                  </div>
                  <div class="mb-5">
                    <label class="block text-sm text-white mb-1" for="beerPlace">Miejsce</label>
                    <input id="beerPlace" v-model="beerPlace" type="text"
                      class="w-full rounded px-3 py-2 bg-neutral-800 text-white border border-neutral-700 focus:outline-none focus:border-primaryOrange"
                      required />
                  </div>
                  <div class="mb-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-slide-up mb-6">
            <div class="bg-secondaryGreen/50 backdrop-blur-sm border border-neutral-700 rounded-2xl p-6">
              <div class="flex items-center justify-between mb-2">
                <span class="text-secondaryGold text-sm">Dziś</span>
                <svg class="w-6" xmlns="http://www.w3.org/2000/svg" width="36" height="32" viewBox="0 0 36 32"
                  fill="none">
                  <path
                  ...
                  <path d="M13.5 16V24" stroke="#D35226" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M19.5 16V24" stroke="#D35226" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path
            ...
            <div class="rounded-2xl p-6 border border-primaryOrange">
              <div class="flex items-center justify-between mb-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="#C8A654" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5">
          ...
          <div class="bg-secondaryGreen/50 backdrop-blur-sm border border-neutral-700 rounded-2xl animate-slide-up">
