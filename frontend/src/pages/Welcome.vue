  ...
  <div class="bg-gradient-to-b from-green-900/20 to-green-900/80 min-h-screen flex flex-col">
    <section class="splide w-full flex-grow relative" aria-label="Splide Basic HTML Example">
      <div class="splide__track max-h-[800px] max-w-[1600px] mx-auto relative">
          ...
          <li class="splide__slide w-full h-full">
            <div class="relative w-full h-full">
              ...
              <div class="absolute inset-0 flex items-center z-40">
                <div class="max-w-screen-xl mx-auto w-full flex flex-col items-start px-4 sm:px-6 lg:px-8 mt-10 sm:mt-16 lg:mt-20">
                  <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="sm:w-10 sm:h-10" viewBox="0 0 40 40" fill="none">
                      <path
                  ...
                  <h2 class="text-xl sm:text-2xl md:text-4xl text-white drop-shadow-lg mb-2 sm:mb-3">Znajdź towarzystwo
                  </h2>
                  <p class="text-sm sm:text-base md:text-[15px] text-white drop-shadow-lg max-w-xl text-white/60">
                    Poznaj ludzi w pobliżu, którzy też mają ochotę na piwo</p>
                </div>
              </div>
            </div>
          </li>
            ...
            <div class="relative w-full h-full">
              ...
              <div class="absolute inset-0 flex items-center z-40">
                <div class="max-w-screen-xl mx-auto w-full flex flex-col items-start px-4 sm:px-6 lg:px-8 mt-10 sm:mt-16 lg:mt-20">
                  ...
                  <h2 class="text-xl sm:text-2xl md:text-4xl text-white drop-shadow-lg mb-2 sm:mb-3">Drugi slajd
                  </h2>
                  <p class="text-sm sm:text-base md:text-[15px] text-white drop-shadow-lg max-w-xl text-white/60">
                    Treść drugiego slajdu</p>
                </div>
              </div>
            </div>
          </li>
        ...
        <div class="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-1/2 transform -translate-x-1/2 w-full max-w-[300px] z-30 px-4">
          <!-- Paginacja -->
          ...
          <div class="splide__arrows flex flex-col gap-2 sm:gap-3">
            <button class="splide__arrow splide__arrow--prev 
                      w-full px-4 sm:px-6 py-2 sm:py-3 rounded-[10px] sm:rounded-[12px] 
                      border border-[#22392E] bg-gradient-to-br from-[#E07352] to-[#D44E25] 
                      shadow-[0_0_20px_0_rgba(212,78,37,0.5)] text-white font-bold text-sm sm:text-base
                      hover:from-[#D44E25] hover:to-[#E07352] transition-all duration-300">
              Wstecz
            </button>
